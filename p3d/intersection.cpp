...
float intersectBox(const vec3 &p, const vec3 &move, float radius, const vec3 &min, const vec3 &max, vec3 *intersection)
{
	...
	t[1] = intersectFace(p, move, radius, vec3(min.x, min.y, min.z), vec3(max.x, min.y, min.z), vec3(max.x, max.y, min.z), vec3(min.x, max.y, min.z), &inter[0]);
	t[2] = intersectFace(p, move, radius, vec3(min.x, min.y, max.z), vec3(max.x, min.y, max.z), vec3(max.x, max.y, max.z), vec3(min.x, max.y, max.z), &inter[1]);
	t[3] = intersectFace(p, move, radius, vec3(min.x, min.y, min.z), vec3(min.x, max.y, max.z), vec3(min.x, max.y, max.z), vec3(min.x, min.y, max.z), &inter[2]);
	t[4] = intersectFace(p, move, radius, vec3(max.x, min.y, min.z), vec3(max.x, max.y, min.z), vec3(max.x, max.y, max.z), vec3(max.x, min.y, max.z), &inter[3]);
	t[5] = intersectFace(p, move, radius, vec3(min.x, min.y, min.z), vec3(max.x, min.y, min.z), vec3(max.x, min.y, max.z), vec3(min.x, min.y, max.z), &inter[4]);
	t[6] = intersectFace(p, move, radius, vec3(min.x, max.y, min.z), vec3(max.x, max.y, min.z), vec3(max.x, max.y, max.z), vec3(min.x, max.y, max.z), &inter[5]);
