...
private:
	...
	{
	public:
		virtual bool apply(const String &name, sptr<Program> program) const = 0;
	};
	...
	public:
		...
		bool apply(const String &name, sptr<Program> program) const { program->setUniform(name, value); }
